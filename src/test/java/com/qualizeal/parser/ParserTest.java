...
public class ParserTest {
	...
	public void shouldBeAbleToParseTheXrayConfigFile() throws FileNotFoundException {
		ToolConfig xrayConfig = new ConfigParser().parse("src/test/resources/xrayConfig.json", ToolConfig.class);
	...
	public void shouldBeAbleToParseTheResultConfigFile() throws FileNotFoundException {
		TestConfig[] testResults = new ConfigParser().parse("src/test/resources/testResults.json", TestConfig[].class);
